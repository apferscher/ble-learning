...
#
# Following files has been copied:
# -- libs/smp_server
# 
# Modifications in the following method:
# -- send_hci 'y#' instead of 's#'
#
...
static PyObject *send_hci(PyObject *self, PyObject *args)
{
    ...
    if (size)
    {
        ...
        {
            PyList_SetItem(packet_list, i, Py_BuildValue("y#", packets_queue.front().buf, packets_queue.front().len));
            packets_queue.pop();
        }
